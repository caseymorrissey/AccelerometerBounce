...
//  Lab 6
//
//  Created by Casey Morrissey on 9/16/13.
//  Copyright (c) 2013 Casey Morrissey. All rights reserved.
//
...
-(void)tick: (CADisplayLink *)sender
{
    ...
    if (self.velocity.x !=vel.x) {
        vel.x *= DAMPERNING_FACTOR;
    }
    if (self.velocity.y !=vel.y) {
        vel.y *= DAMPERNING_FACTOR
    }
